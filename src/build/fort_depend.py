    ...
    for i in fob:
        ...
        for j in i.uses:
            try:
                ...
                if j in ["petsc", "mpi", "iso_fortran_env", "cgns", "slepceps"]:
                    ...
                    print(
                        "\033[031mError\033[039m module \033[032m"
                        + j
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--build", nargs=1, help="Build Directory (prepended to all files in output", default="")
